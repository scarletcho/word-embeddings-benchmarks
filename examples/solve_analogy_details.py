...
print('Accuracy: {} %'.format(float(score_sum)/float(questioned_cnt)*100))
print('================================================')
...
print('Accuracy: {} %'.format(float(syn_score_sum)/float(syn_questioned_cnt)*100))
print('================================================')
...
print('Accuracy: {} %'.format(float(sem_score_sum)/float(sem_questioned_cnt)*100))
print('================================================')
